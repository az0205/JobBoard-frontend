...
<h1 className='text-3xl font-extrabold text-gray-800 mb-6 text-center'> Recruiter <span className="text-blue-600">Login</span></h1>
            ...
            <button className='w-full mt-2 text-blue-600 hover:text-blue-800 transition cursor-pointer' onClick={() => navigate('/recruiter/register')}>Register</button>
        </div>
        </div>
        </>
    )
